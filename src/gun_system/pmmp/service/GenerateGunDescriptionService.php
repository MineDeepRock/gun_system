...
class GenerateGunDescriptionService
{
    static function get(Gun $gun): string {
        ...
        $describe .= "(".$gun->getAttackPoint()->getValue().")";
        ...
        $describe .= "(".$gun->getBulletSpeed()->getPerSecondBlock()."m/s)";
        ...
        $describe .= "(".$gun->getFiringRate()->getPerSecond()."毎秒)";
        ...
        $describe .= "(".$gun->getPrecision()->getADS()."%)";
        ...
        $describe .= "(".$gun->getPrecision()->getHipShooting()."%)";
